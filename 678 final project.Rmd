...
##multilevel model
library(lme4)
model=lmer(price ~ minimum_nights + reviews_per_month+ room_type + (1 + minimum_nights | reviews_per_month),data=data)
...
##model2
library(lme4)
model2=lmer(price ~ minimum_nights + reviews_per_month+ room_type + reviews_per_month*room_type + (1 + minimum_nights | reviews_per_month),data=data)
